...
.method constructor <init>(ZII)V
    ...
    .line 56
    iput p2, p0, Lio/grpc/internal/ServiceConfigInterceptor;->maxRetryAttemptsLimit:I

    .line 57
    iput p3, p0, Lio/grpc/internal/ServiceConfigInterceptor;->maxHedgedAttemptsLimit:I
...
.method handleUpdate(Ljava/util/Map;)V
    .locals 4
    ...
    .line 64
    new-instance p1, Lio/grpc/internal/ManagedChannelServiceConfig;
    ...
    invoke-direct {p1, v1, v2, v0, v0}, Lio/grpc/internal/ManagedChannelServiceConfig;-><init>(Ljava/util/Map;Ljava/util/Map;Lio/grpc/internal/RetriableStream$Throttle;Ljava/lang/Object;)V

    goto :goto_0

    .line 67
    :cond_0
    iget-boolean v1, p0, Lio/grpc/internal/ServiceConfigInterceptor;->retryEnabled:Z

    iget v2, p0, Lio/grpc/internal/ServiceConfigInterceptor;->maxRetryAttemptsLimit:I

    iget v3, p0, Lio/grpc/internal/ServiceConfigInterceptor;->maxHedgedAttemptsLimit:I
