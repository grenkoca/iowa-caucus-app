...
.method public close()V
    ...
    .line 140
    iput-boolean v1, p0, Lio/sentry/connection/BufferedConnection;->closed:Z
    ...
    .line 147
    :goto_0
    iget-object v3, p0, Lio/sentry/connection/BufferedConnection;->executorService:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    .line 150
    :cond_1
    sget-object v3, Lio/sentry/connection/BufferedConnection;->logger:Lorg/slf4j/Logger;

    const-string v4, "Still waiting on buffer flusher executor to terminate."
    ...
    invoke-interface {v2, v0, v1}, Lorg/slf4j/Logger;->warn(Ljava/lang/String;Ljava/lang/Object;)V
